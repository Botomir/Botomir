...
// If we restart the bot, previous scanner may be removed from the cache, and the
// bot would not be aware if they receive a reaction
// This function allows us to add the message to our cache and register reactions
