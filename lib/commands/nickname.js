...
function unspecifiedNicknameError(message) {
    message.channel.send("Error: no nickname specified")
        .then(r => console.log("Successfully sent unspecified nickname error message: " + r))
        .catch(e => console.log("Error: encountered error when sending unspecified nickname error message: " + e));
}
